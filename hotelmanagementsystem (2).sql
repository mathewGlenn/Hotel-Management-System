...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 02, 2017 at 06:58 PM
...
INSERT INTO `tbl_allcheckins` (`Room_ID`, `Customer_ID`, `Room_Type`, `Room_Name`, `Person_No`, `Description`, `Vehicle_Info`, `Checkin`, `Checkout`, `orHour`, `Total_Amount`) VALUES
...
('87783240990950', 'Double', '104', 3, 'Air-conditioned; Free lunch; Installed cabled TV.  2 bedrooms; \ngood for 4 persons.\nmaximum of 6 persons;\nper  hour= 300;\nper day= 1999;\nextra-person=199', '199', '300', 1999, 63),
('826337998792', 'Deluxe', '103', 3, 'Air conditioned; Hot Tub; Free Dinner; 2 King-size and 1 Queen-size bed. Installed cabled TV with Stereo.\ngood for 3 person;\nmaximum of 5 persons;\nper hour= 399;\nper day= 4999;\nextra-person=299;', '299', '399', 4999, 64),
('76473940243', 'Family', '102', 5, '1 queen-size bed & 2 extra-long bed; Airconditioned; installed cabled tv; free lunch good for 5 person. maximum of 7 person.\r\nper hour= 300;\r\nper day= 2900;\r\nextra-person=200;', '300', '2900', 200, 66);
...
--
-- Dumping data for table `tbl_occupiedrooms`
--

INSERT INTO `tbl_occupiedrooms` (`Room_ID`, `Room_Type`, `Room_Name`, `Person_No`, `Description`, `Rate_Per_Hour`, `Rate_Per_Day`, `Extra_Person_PH`, `Vehicle_Info`, `Checkin`, `Checkout`, `orHour`, `Total_Amount`, `uid`, `extra_person`) VALUES
('6737687394932', 'Standard', '101', 2, 'Air conditioned room; installed TV; 1 Queen-size bed. minimum of 2 person.maximum of 4 person. \r\nper hour= 99. per day=999. \r\nextra-person=99. ', '99', '999', 99, '', 'Monday, October 2, 2017', 'Monday, October 2, 2017', '', '?9189 ', 28, '');
...
(13, '6737687394932', 'alllen', 'Standard', '101', 4, 'Monday, October 2, 2017', 'Thursday, October 5, 2017', 'Tuesday, October 10, 2017', '?5391 ', '?2695 ', 'Half Paid', 'Air conditioned room; installed TV; 1 Queen-size bed. minimum of 2 person.maximum of 4 person. \r\nper hour= 99. per day=999. \r\nextra-person=99. ', '99', '999', '99', '07:00:59 AM'),
(14, '6737687394932', 'George Martin', 'Standard', '101', 2, 'Monday, October 2, 2017', 'Wednesday, October 11, 2017', 'Friday, October 13, 2017', '?2196 ', '0', 'Fully Paid', 'Air conditioned room; installed TV; 1 Queen-size bed. minimum of 2 person.maximum of 4 person. \r\nper hour= 99. per day=999. \r\nextra-person=99. ', '99', '999', '99', '08:00:00 AM'),
(15, '87783240990950', 'Ariza', 'Double', '104', 1, 'Monday, October 2, 2017', 'Monday, October 2, 2017', 'Wednesday, October 4, 2017', '?2198 ', '?1099 ', 'Half Paid', 'Air-conditioned; Free lunch; Installed cabled TV.  2 bedrooms; \r\ngood for 4 persons.\r\nmaximum of 6 persons;\r\nper  hour= 300;\r\nper day= 1999;\r\nextra-person=199', '300', '1999', '199', '10:47:13 PM');
...
('76473940243', 'Family', '102', 5, '1 queen-size bed & 2 extra-long bed; Airconditioned; installed cabled tv; free lunch good for 5 person. maximum of 7 person.\r\nper hour= 300;\r\nper day= 2900;\r\nextra-person=200;', '300', '2900', 200, 61),
('87783240990950', 'Double', '104', 4, 'Air-conditioned; Free lunch; Installed cabled TV.  2 bedrooms; \r\ngood for 4 persons.\r\nmaximum of 6 persons;\r\nper  hour= 300;\r\nper day= 1999;\r\nextra-person=199', '300', '1999', 199, 63),
('826337998792', 'Deluxe', '103', 3, 'Air conditioned; Hot Tub; Free Dinner; 2 King-size and 1 Queen-size bed. Installed cabled TV with Stereo.\r\ngood for 3 person;\r\nmaximum of 5 persons;\r\nper hour= 399;\r\nper day= 4999;\r\nextra-person=299;', '399', '4999', 299, 64),
('6737687394932', 'Standard', '101', 2, 'Air conditioned room; installed TV; 1 Queen-size bed. minimum of 2 person.maximum of 4 person. \r\nper hour= 99. per day=999. \r\nextra-person=99. ', '99', '999', 99, 65);
...
--
ALTER TABLE `tbl_allcheckins`
  MODIFY `Customer_ID` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
--
-- AUTO_INCREMENT for table `tbl_availablerooms`
--
ALTER TABLE `tbl_availablerooms`
  MODIFY `uid` int(78) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
--
-- AUTO_INCREMENT for table `tbl_occupiedrooms`
--
ALTER TABLE `tbl_occupiedrooms`
  MODIFY `uid` int(78) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
...
--
ALTER TABLE `tbl_reservationhistory`
  MODIFY `Customer_ID` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
--
-- AUTO_INCREMENT for table `tbl_rooms`
--
ALTER TABLE `tbl_rooms`
  MODIFY `uid` int(78) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
--
